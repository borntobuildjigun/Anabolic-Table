...
export const INGREDIENTS: Record<string, Record<string, Ingredient>> = {
  carbs: {
    '현미밥': { name: '현미밥', calories: 150, carbs: 33, protein: 3, fat: 1, unit: 'g', readyMealUnit: { name: '햇반(작은공기)', weight: 130 } },
    '흰쌀밥': { name: '흰쌀밥', calories: 130, carbs: 28, protein: 2.5, fat: 0.3, unit: 'g', readyMealUnit: { name: '햇반(한공기)', weight: 210 } },
  ...
  protein: {
    '닭가슴살': { name: '닭가슴살', calories: 110, carbs: 0, protein: 23, fat: 1, unit: 'g', readyMealUnit: { name: '스팀 닭가슴살(팩)', weight: 100 } },
    ...
    '캔참치(기름제거)': { name: '캔참치', calories: 100, carbs: 0, protein: 22, fat: 1, unit: 'g', readyMealUnit: { name: '라이트 참치(캔)', weight: 100 } },
  },
  fats: {
    '아몬드': { name: '아몬드', calories: 580, carbs: 20, protein: 21, fat: 50, unit: 'g', readyMealUnit: { name: '한줌견과(봉)', weight: 20 } },
